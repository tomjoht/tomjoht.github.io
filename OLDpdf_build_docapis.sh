...
bundle exec jekyll build --config configs/_config_pdf_one.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_two.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_three.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_four.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_five.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_six.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_seven.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_eight.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_nine.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_ten.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_eleven.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_twelve.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_thirteen.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_fourteen.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_fifteen.yml --limit_posts 1;
echo "the PDF ...";
...
bundle exec jekyll build --config configs/_config_pdf_sixteen.yml --limit_posts 1;
echo "the PDF ...";
