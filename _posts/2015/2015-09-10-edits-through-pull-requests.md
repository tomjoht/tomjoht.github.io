...
<a href="http://idratherbewriting.com/learnapidoc/pubapis_github_pull_requests"><img src="{{ "images_api/github_compare_to.png" | prepend: site.baseurl }}" alt="Pull request tutorial" /></a>
