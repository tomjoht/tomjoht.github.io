...
<img src="{{ "https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/bluehostpingdom.png" | prepend: site.baseurl }}" alt="WordPress on Bluehost with MaxCDN" />

After moving my blog to Jekyll and hosting on Github, here are the average response times:

<img src="{{ "https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/githubpingdom.png" | prepend: site.baseurl }}" alt="Jekyll on Github" />
