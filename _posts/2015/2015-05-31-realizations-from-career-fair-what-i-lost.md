...
(If you can't see the booth text and you actually want to read it, here's a <a href="{{ "/images/closerlook.png" | prepend: site.baseurl }}">closer look</a> and <a href="https://idratherassets.com/files/techwriter_career_fair.pdf" target="_blank">the accompanying text</a>.)
