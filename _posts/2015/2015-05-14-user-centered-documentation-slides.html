...
<p>This is a post in my on-going <a href="http://idratherbewriting.com/series/user-centered-documentation/">series on user-centered documentation</a>.</p>
...
<p><a href="http://tomjohnson1492.github.io/user-centered-documentation/"><img src="/images/ucdthumb.png" alt="user-centered documentation" width="350" height="283" class="alignnone size-full wp-image-22705" /></a></p>
...
* You can provide some common facets such as troubleshooting, getting started, most popular, or by format (video, PDF, webhelp). But these facets aren’t going to solve fundability problems for users. (They’re still a good idea to implement, though.)
