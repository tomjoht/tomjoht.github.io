...
<img src="{{ "/learnapidoc/images/restapi_hmac.svg" | prepend: site.baseurl }}" alt="HMAC workflow" />
...
<img src="{{ "/learnapidoc/images/oauthwindow.png" | prepend: site.baseurl }}" alt="OAuth login window" />
...
<img src="{{ "/learnapidoc/images/restapi_oauth.svg" | prepend: site.baseurl }}" alt="OAuth workflow" />
...
<a style="max-width: 700px;" href="https://sendgrid.com/docs/User_Guide/Settings/api_keys.html"><img src="{{ "/learnapidoc/images/sendgridapikeys.png" | prepend: site.baseurl }}" alt="SendGrid API Keys" /></a>
...
<a  style="max-width: 700px;" href="https://developer.github.com/v3/#rate-limiting"><img src="{{ "/learnapidoc/images/githubratelimiting.png" | prepend: site.baseurl }}" alt="Rate limiting section from Github" /></a>
