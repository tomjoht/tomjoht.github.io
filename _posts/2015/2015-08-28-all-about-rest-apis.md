...
<img src="{{ "/learnapidoc/images/restapi_restapi.svg" | prepend: site.baseurl }}" alt="REST API" />
...
<img src="{{ "/learnapidoc/images/restapi_www.svg" | prepend: site.baseurl }}" alt="Web as REST API" />
