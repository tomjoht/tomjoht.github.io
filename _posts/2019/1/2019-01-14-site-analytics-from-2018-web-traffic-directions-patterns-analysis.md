---
title: "Site analytics from 2018 -- web traffic sources, patterns, and analysis"
categories:
- general
- api-doc
keywords:
summary: "Every year, when I re-examine my site analytics, I take the time to reflect on trends I’m seeing with traffic to my own site. Not necessarily industry trends, just trends about which topics are popular based on my site. Based on these trends, I assess and re-evaluate some of my directions. This year, I found that the increase in traffic on my API documentation site (which accounts for 59% of my overall site traffic) suggests that more engineers are writing docs. This confirms my earlier predictions at the beginning of 2018 that specialization is driving more engineers to write API documentation, with technical writers playing more supporting editorial and publishing roles."
bitlink: http://bit.ly/siteanalytics2018
published: false
---
...
Here's the big revelation. About 59% of my overall traffic to my site goes to my <a href='https://idratherbewriting.com/learnapidoc/'>API documentation site</a>:

<figure><img src="/images/learnapidocmetrics.png" alt="API documentation traffic" /> <figcaption>Traffic related to API documentation dwarfs all other traffic.</figcaption></a></figure>
...
Based on these analytics, what conclusions can we draw? Most traffic is coming into the API documentation site, so I should continue to work on and develop the content there.

Just because the content isn't in the form of blog posts, it doesn't mean traffic is any less. I worked a ton on the content there during 2018 &mdash; incremental updates, refinements, re-organizations, screenshots, visuals, and more. I spent as much time working on the API content as on my regular blog, but look at the differences in traffic.

Only 4.42% of traffic to my site comes in through blog posts written in 2018, whereas 58.8% of the traffic comes in through the API documentation site. 1.28% traffic comes in through my [Simplifying Complexity](/simplifying-complexity) site. (The rest of the traffic comes in through older blog posts or other pages.) The increased traffic on my API documentation site grew my page views from 845,066 in 2017 to 1,552,615 in 2018, which is nearly double! This lopsidedness in traffic has given me a lot to think about.

That said, I think the engineering audience who comes to the API documentation site is less likely to comment, subscribe, and become regular readers. The bump in newsletter subscribers (about a thousand this year) doesn't necessarily reflect double the site traffic.
...
Let's reflect on some ideas and predictions I wrote about in [What technical writing trends will we see in 2018?](https://idratherbewriting.com/2018/01/02/technical-writing-trends-2018-and-2017-review/) at the beginning of the year. I said,
...
If that weren't the case, why would so many engineers be landing on my site? I mean, traffic to that site accounts for 59% of my site traffic!
...
Based on these metrics, my guess is that more engineers are writing API docs. Given that the 2017 Bureau of Labor Statistics data (as compiled by the [STC Salary Database](https://www.stc.org/salary-database/)) says that only "10" technical writer jobs were added to the U.S. economy, it further reinforces the idea that more engineers are writing docs.
...
I don't have a five-year history of engineering employment job growth (there are many different developer jobs), but if you compare the IT jobs ads between Q2 2017 and Q2 2018 for "software developers," you will find that "postings for software developers increased by more than 50,000.
 ([IT in Demand: Software developer job postings continue to increase](https://www.aitp.org/blog/aitp-blog/2018/09/25/it-in-demand-software-development-job-postings-continue-to-increase/)):
...
[Docs-as-code tooling](https://idratherbewriting.com/learnapidoc/pubapis_docs_as_code.html) has flourished as a standard approach to writing and publishing documentation, in part because of the increased numbers of engineers writing docs.
...
In other posts this year about trends, I explained the ramifications of the increase in specialization and seeing more engineers write docs:
...
You can read my analysis of metrics for previews years with these posts:
