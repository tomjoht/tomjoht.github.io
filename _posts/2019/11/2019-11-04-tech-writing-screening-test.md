...
{{site.data.alerts.note}}Nov 12, 2019 Update: See my follow-up post here: [Follow-up to 4 Technical Writing Tests Post](/blog/follow-up-to-technical-writing-tests-for-screening-candidates).{{site.data.alerts.end}}
