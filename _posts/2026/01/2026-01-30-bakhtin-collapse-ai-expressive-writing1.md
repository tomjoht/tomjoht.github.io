---
title: "Bakhtin and model collapse: How to use AI with expressive writing without generating AI slop"
permalink: /blog/bakhtin-collapse-ai-expressive-writing
date: 2026-01-30
categories:
- ai
- ai-book-club
...
2. Use AI as a verification tool
3. Use AI for the alien perspective

### 1. Use AI as a research assistant

The first technique is to use AI as a research assistant. Consider this approach:

1. Write out a draft of a blog post using your own thoughts, voice, and words. No AI at this point. The blog post could be 500 words or 3,000, depending on how much you have to say.  
2. Plug your post into [Gemini Deep Research](https://gemini.google/overview/deep-research/) (or similar) and ask AI to research the topic of your post for you. Read the lengthy report.  
3. From the research report, identify several sources mentioned that you think are significant in the discussion.   
4. Read the sources and pull out some interesting quotes or passages.  
5. Now make a second pass through your essay and interweave/reference the quotes as desired into the body of your content.  
6. Follow up external quotes with summaries and analyses of these other voices.  
7. Ask AI to verify that your interpretations of the source are correct. 
...
### 3. Use AI for the alien context
...
All of the techniques I've described don't result in AI slop. Instead, they help take writing to the next level. Some of my most popular posts in 2025 (such as [The isolation and loneliness of tech writing may get worse as AI accelerates](/blog/isolation-loneliness-worsens-with-ai) and [12 predictions for tech comm in 2026](/blog/tech-comm-predictions-for-2026)) used these methods. I encourage you to experiment with AI not to replace your voice, but to expand the social atmosphere in which your voice lives. Try it out, experiment, and engage with these other voices, even, and perhaps especially, when that voice is an alien one.

## Works cited

Bakhtin, M. M. *The Dialogic Imagination: Four Essays*. Edited by Michael Holquist, translated by Caryl Emerson and Michael Holquist, University of Texas Press, 1981. See [The Dialogic Imagination (Excerpt)](https://www.d.umn.edu/~cstroupe/handouts/8906/Mikhail-Bakhtin-The-Dialogic-Imagination-Excerpt.pdf).
...
Also relevant but not used, [AI Can Teach Our Students the Art of Dialogue](https://thereader.mitpress.mit.edu/ai-can-teach-our-students-the-art-of-dialogue/), by David Weinberger, MIT Press.