---
title: "Medium CEO explains how AI is changing writing"
permalink: /blog/stubblebine-how-ai-is-changing-writing
date: 2025-10-30
categories:
- ai
- writing
...
This is the core of the incentive problem. Writers on Medium are sharing life lessons. "This thing happened to me and I want to share share it with you" (28:54). Stubblebine sees great value in sharing your life's experiences with others, and I completely agree. This has been the motive behind so much of my writing. Are AI sites threatening to upend that connection with readers?

Stubblebine says Google's great invention with the Internet was to allow anyone to start writing about a topic and find readers. "The idea that you can just write something on the internet and traffic will just show up out of the blue," he said, "That's kind of like... Google made the public internet" (29:36). But now with AI chat, many of those readers never fully go to your site. He said the traffic trade-off is devastating, estimating that "we lose about a 100 clicks from traditional Google search for every one click we get back from a Gemini summary" (43:33). 
...
> **Stubblebine:** "...we learned really early on that medium is a big enough big enough corpus of data that we can poison the... results of any large language model... the medium training... set of just the medium corpus is so heavy on m dashes... so when you hear oh this must have been written by AI because it's got so many m dashes it's because the AI is trained on medium..." (16:18, 16:57).

> **Kantrowitz:** "Wait, this is why ChatGPT writes on em dashes" (17:14).
...
In fact, many people think users won't even read the docs directly but rather consume them through chat interfaces instead (an idea I wrote about [here](/blog/ai-chat-interfaces-are-the-new-user-interface-for-docs)). If that's the case, do you really want to be writing docs by hand to ensure they have voice or something?

Perhaps the Stubblebine podcast caught my attention so much because it once again highlights this strange dichotomy in my attitude toward AI, which is what I also focused on in [my review of Warner's book](/blog/jonathan-warner-more-than-words-book-review). At work, I'm a proponent of using AI to write. On my personal blog, I'm a proponent of using writing as a tool for thinking.
