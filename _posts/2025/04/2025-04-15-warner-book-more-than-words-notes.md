...
* In terms of expressive writing, 100% agree. However, his view of "writing" seems to be too narrow. There's a lot of non-expressive writing. In fact, the bulk of what employees write in corporations is outside the scope of Warner's book. Not just technical documentation, but reports, procedures, policies, updates, etc. Much of this type of writing (professional writing) is ripe for AI automation. This is a point he fails to acknowledge other than making a few brief passing mentions in places (such as with the biliterate brain comments).
