...
In other words, Hao makes it clear that she isn't opposed to AI as a technology. Instead, the book's exposé stems from her deliberate journalistic choice to critique a specific model of AI development&mdash;one that's centralized, extractive, and harmful. Hao's position is that there is a different, more ethical path for AI. She spends her final chapter outlining this alternative vision, providing examples of projects that are smaller in scale, community-focused, and designed to provide specific benefits to the people who contribute their data and resources.
