...
Subject matter expertise gives you the ability to properly vet the accuracy of an AI's output. Subject matter expertise, both for the products you document and the domain you're operating in, lets you to better iterate on AI outputs, to know when the outputs are suspect and need more QA, and more. I wrote about this in my post [Why attitudes and experiences differ so much with regards to AI among technical writers](/blog/plurality-of-ai-attitudes-experiences). In that post, I noted that AI has a "jagged edge," where those with subject matter expertise can achieve much more proficiency and productivity with AI. This is in contrast to someone who lacks that knowledge and can't evaluate, iterate, and adjust the prompts or strategy on the fly based on the quality of the output they're seeing.
