...
I'm still fine-tuning the content and have a lot more work to do. Technology evolves daily, it seems, so things gradually slide out of date. For example, Swagger UI has come out with a new display that fixes some issues I had noted previously. It'll be at least another month of editing before I'm ready to kindle-ize my content.
