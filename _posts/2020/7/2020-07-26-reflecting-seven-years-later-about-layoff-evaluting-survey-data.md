...
In the following sections, I'll highlight the survey responses and provide some analysis. Note that with freeform responses, I identified key themes in responses and counted up their instances. Some people gave more than one reason. In that case, the number of reasons won't correlate with the number of responses. Also, some people were laid off multiple times at different companies, and they explained differing reasons for each scenario.
...
* Increased awareness among PMs (1)
* Supply and demand scarcity (1)
...
* Hybrid model, embed with product teams (11)
* Sponsor essential (3)
...
I also realized that making sense of any survey data is challenging and more effort than I usually think. But unless I look closely and try to interpret responses, what's really the point of creating the survey in the first place?

## Trending highlights

Now for the higher-level extrapolation and analysis. Based on the responses, I don't think there's any clear correlation between an org model and the tech writer's sense of value/importance. Org models are probably more nuanced than the three buckets I described (centralized, distributed, decentralized). That said, 48% of people disagreed that the org model has no impact, so it does have an influence, but it seems other factors are more important (e.g., appropriate allocation of projects, executive sponsorship, integration with teams, alignment with strategic priorities, etc).

Most writers feel that a distributed model (hybrid) is best. Sit with the engineering teams, but find a larger tech writer community within the company. Centralized tech comm teams might benefit from increased consistency and more formal writing standards, but they take a hit with visibility and rapport with engineering teams. By not being co-located with engineering teams, these centralized tech writers are less known, less visible, less integrated, less kept in the loop, less understood, etc. The benefits you gain from co-locating with product teams in an embedded way outweighs the benefits you gain from co-locating with other tech writers. And users care more about content than commas.

Further, if you can embed with engineering teams, you're less likely to be diluted across too many projects and "kept dumb," as one commenter put it. When you support 6-10 projects, it's inevitable that you'll lean towards being a generalist. And as a generalist, you likely won't provide the level of insightful input, feedback, commentary, correction, or other intelligence to product teams that will make your value spike.

When you become a product SME, teams are much more likely to value you. And your docs are more likely to become high-quality docs with visible customer impact. You'll be gathering more valuable information that results in a much influential result. Tech writers only have as much value as the information they provide, so the more valuable information you can gather and communicate, the more valuable you become.

Internal teams will see your output and esteem you with higher respect and importance. Customers will express their appreciation for the docs. Sales will use your docs in pre-sales scenarios, which will ratchet up your value. But if your only contribution to the project is to fix the language, your value will be much lower (especially if others don't even understand the style adjustments you're making).

One trend you especially want to avoid is the downward cycle of poor documentation and under-resourcing. If the docs lack value because they are poor, this can lead to less staffing/prioritization for docs, which leads to even poorer docs. Docs aren't important because they're poor, so no effort/priority is given to docs, which makes them even worse.
...
In fact, given our current pandemic times, it's easy to co-locate with teams &mdash; co-location just means attending meetings with teams online, more or less, so you can co-locate with whomever you want, as long you can get an invite to the meetings.

Further, virtual attendance of meetings lets you more easily tune out those meetings where the signal-to-noise ratio is low (e.g., some engineering standups where engineers prattle on about issues that seem irrelevant). Perhaps give the meeting your partial attention to avoid feeling like you're wasting your time.

Attending meetings, ramping up on products, tracking down and interviewing engineers, and integrating yourself and energy in other ways takes time. This is likely challenging if you have many projects. I still don't know how to reduce project loads. It's difficult to tell teams "no." (Saying no can create more work than actually creating the documentation itself, I've found.) My experimental strategy is to adjust my level of effort with the team (choosing between playing a role as an author, editor, or publisher in varying degrees). But I need a better way of somehow identifying and labeling docs that I didn't write.
...
How does the survey data change or influence the earlier takeaways? Previously, I was leaning towards a correlation with organization models and value. But the responses to this survey encouraged me to rethink the relevance of the org model. The distributed model seems best, but no matter how your company draws the org lines, I think clever tech writers who follow these three principles will find success.

The last bullet (cultivating sponsorship) is one that I haven't expanded much on, but it's something I've been thinking about. The great irony of my career is to be a thought influencer (sorry for the cliche) outside of work through this blog and other activities, but to be relatively invisible inside my company, especially to business leaders and others. I can connect with other tech writers, so why can't I connect with business leaders and cultivate an influence of executive sponsorship? Well, I haven't tried. I don't write an internal blog. I don't have an internal newsletter. I don't write posts on different topics and share the results and my thoughts with others. I haven't figured out how to do that, nor how to overcome the awkwardness and lack of a clear path for this effort.

But I'm noodling on an idea that I intend to experiment with more &mdash; a "center of excellence." This would be an internal site that is part blog, part best practices, part informational announcements. I also want to build up a stakeholder mailing list, and then try to post once a week in our center of excellence and share the post on the mailing list. I'm not sure how this will go or how much time it will take. I've been blogging externally for more than a dozen years. Influence, either internal or external, is a slow process.

Some of the responses give me encouragement for this direction. In response to, "Why do you think the company treated tech comm as important and highly valuable?" one of the respondents said:

> Strong product expertise built over time, great relationship with stakeholders. Looking for opportunities to improve UI language, driving initiatives that brought visibility to the end documentation and also training product teams on the standards and process that impact them. Technical writers run learning sessions on API documentation for product mangers to help them understand what's important for great doc.

I think many people within a company might be interested in similar learning sessions about documentation, helping them understand what makes docs good, key qualities to look for, and more. I can't imagine these sessions being very packed or even well-attended, but maybe eventually they can reach the right stakeholders, little by little.
