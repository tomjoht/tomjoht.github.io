...
Some other AI tools sidestep the problem of inaccuracy by focusing mostly on language editing from content you supply. One of these tools is [Wordtune](https://wordtune.com/), which uses AI to help with editing and rewriting existing content rather than generating all content from scratch. The tool is like having a personal editor to guide and shape your writing&mdash;while still allowing you to retain your voice and control over the content. Wordtune recently added “spices,” which are AI features that allow you to generate more content if desired, such as expanding on an existing paragraph or providing examples.
...
In my experience, leveraging these tools involves a mix of human and machine input. For example, you crank out a first draft on your own, then maybe augment some details through AI as well as fix the language. After that, you make more human edits for composition, organization, and flow. You might then let the Wordtune AI take another pass at the language to smooth out the changes. Then you manually read and make adjustments again. In other words, writers will leverage AI tools to help in the writing process, not abdicate the entire writing to machines. (Every time I try to abdicate the writing process to AI, the outcome fails. In writing this post, I did use Wordtune similar to the process I described here. Mostly, I'm using Wordtune like a next version of Grammarly.)
...
Playing around with ChatGPT, I've noticed that AI-written content has a certain veneer to it that's a bit tough to describe. The perspective is explanatory, with generalized language and a muted tone. The content is more expository rather than argumentative. Human-written content is more opinionated. Humans tend to take a stand on an issue, conjecturing a thesis of some kind. A bold thesis, with interwoven personal experiences, is something you won't find AI tools generating. AI tools generate content that reads more like an encyclopedia article. 

This veneer of general exposition might seem helpful at first, but the tone muffles what would otherwise be the writer's unique voice and insights. Sliding into general exposition is a recipe for boring content.

As such, I see human-written content steering more towards thesis/argument and personal experience. These are gaps that AI tools can't fill in. Unfortunately, in tech comm, neither of these characteristics are common in content, so this point is more about writing in general.
...
As a result of AI-assisted writing, our productivity could be much higher. Those who reject AI tools might find themselves on a horse-and-buggy trying to compete with fast-driving cars along a highway. I’d like to be able to create an intelligent blog post in a few hours, with interesting insights, no grammar errors, and other characteristics of engaging content.

In Cal Newport’s _Deep Work_, he says one characteristic of successful people is their ability to “work well and creatively with intelligent machines” (28). He explains:
