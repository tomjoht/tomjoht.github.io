...
**Too much detail**. While reading some posts, I grew bored in places and decided to drastically trim or summarize the content. In some sections, I get way more detailed than I needed to be (such as in summarizing Nicholas Carr’s book, or in describing how to sideload APKs onto a feature phone). I used my own interest level in deciding what to keep or discard. If I get bored reading it, then I trim it down or remove it. Better to mention a point briefly and get to the good stuff faster.
