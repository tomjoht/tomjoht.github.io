---
title: "Notes and discussion for Building the Cycling City: The Dutch Blueprint for Urban Vitality"
...
description: "In <a href='https://www.amazon.com/Building-Cycling-City-Blueprint-Vitality/dp/1610918797'><i>Building the Cycling City: The Dutch Blueprint for Urban Vitality</i></a>, Chris and Melissa Bruntlett describe how the Dutch achieved so much cycling success, and how other cities might do the same. The authors resist prescribing simplistic step-by-step blueprints but rather outline some overarching principles: Seamlessly integrate cycling with public transit, pursue customized strategies based on each city's unique landscape and culture, take an iterative approach to infrastructure, using tactical urbanism and prototyping, and more."
image: 1-ebikesreplacecarsthumb.jpg
---

In the following sections, I've pulled out my 12 more concrete takeaways from their book. The authors aren't this explicit in identifying 12 techniques, much less numbering them. This is just my desire for more concrete strategies and takeaways. I created these notes for a book club discussion focused on automotive and transportation books.

Also note that these notes were AI-assisted, and images were generated by DALLE3. 
