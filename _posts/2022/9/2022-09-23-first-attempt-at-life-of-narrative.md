...
If you've ever visited a dam, beholding its sheer size and scope puts the mind into a state of bewildering awe. To touch the massive turbine that converts mechanical energy to electrical energy and feel its power must have filled the author with some mystery and wonder. It's not too different from gazing out into the massive blue ocean, its waves continually rolling ashore. Or looking at a powerful river with slow-moving but strong current, winding its way through the landscape with unrelenting force. But in this case, rather than with nature, the experience is with the machine performing some incomprehensible feat. 

I often feel similarly mesmerized when I'm close to a train as it goes by, such as when I'm on a bike and am close to the rails so that I can see the detail of the giant steel wheels rolling smoothly yet forcibly along the track, moving the giant metal beast forward.

Documenting this requests workflow was like that, only a bit different. To see that there are hundreds of people across fifty or more teams all working on some aspect of this product, with an endless complexity of services and frameworks handling every detail of the experience -- it was kind of mind-blowing. It's the same language-defying experience that Didion describes -- like, oh my god, this is both mysterious and fascinating and massive. It's incredibly complex but all working together harmoniously &mdash; how is it even possible? 
...
For Kelly, the Internet itself is the "evocative object," as one psychologist puts it, that triggers off a state of reflection about the beauty of the machine. Different technical objects, such as a a stethoscope for a doctor, a pen for a writer, or a radio for a dispatcher, can "serve as a springboard for identity or for reflection and thinking," according to MIT sociologist Sherry Turkle (qtd. in Kelly, 322). 

For Kelly, that evocative object that triggers his awe for technology's beauty is the Internet. Kelly explains: 
...
I quote at length here because, as I said, experiencing the beauty of technology is somewhat beyond language to fully articulate. Previously, in most documentation projects as a technical writer, I'd focused on some smaller part of the machine and documented it, without fully understanding the complexity of the whole. It was only while writing this *Life of a [something]* narrative that I moved beyond that reductionist point of view (documenting a specific piece of something larger) to glimpse into the depths of a system much more intelligent and mystical than I'd realized.
