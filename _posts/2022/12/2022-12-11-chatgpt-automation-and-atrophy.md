...
In other words, our sense of space and environment provides a foundation for memories to form and have context in the brain. If automation removes place learning, these physical aspects of the brain might become impaired. 
...
Part of the writing process is sorting out an idea for yourself, helping you think. If we outsource that thinking process, it atrophies in us. It's the equivalent of plagiarizing an essay in a college class &mdash; if we bypass the writing task, we skip out on all the critical thinking skills we're supposed to develop. 
...
Another element missing from writing with ChatGPT is the spark of discovery that you often experience midway through a post, stumbling onto some idea you hadn't planned. It doesn't happen. This spark of discovery is what usually makes writing "hot," or what makes it compelling to read. The discovery is often the realization element that creates the arc of a story as well. ChatGPT isn't good at injecting a spark of discovery; at most, it might incorporate a bizarre fictional element if you specifically request it, but ChatGPT isn't good at coming up with new ideas. You can't just tell it to come up with a unique realization about a topic.
...
This brings me to a major flaw in ChatGPT: its uncanny ability to make detail up. If you ask ChatGPT for quotes from a book, it will literally invent quotes that sound like they might come from a book but don't. 

<figure><img src="https://s3.us-west-1.wasabisys.com/idbwmedia.com/images/chatgpt-invented-quotes.png" alt="" /><figcaption></figcaption></figure>
...
Why does ChatGPT just make up quotations that don't exist, without letting on that the quotations aren't real? I'm not sure, but realizing this was game-changing in my usage of ChatGPT (and why ChatGPT might not be the homework killer many fear).

As I attempted to write this post with ChatGPT, I asked ChatGPT to list some other books related to this topic. Sometimes, with this request, it would return nonsense books that it invents. But it also suggested Kevin Kelly's [_The Inevitable_](https://www.amazon.com/Inevitable-Understanding-Technological-Forces-Future/dp/0143110373) (a real book) as another book addressing similar themes. I asked ChatGPT to summarize key points from Kelly's book about the effect of AI tools on writing, but it wasn't clear whether ChatGPT was accurately delivering me this info or making it up. I couldn't just summarize other texts that I haven't read like this, trusting in generative AI's accuracy, especially knowing that the bots fabricate.
...
<figure><img src="https://s3.us-west-1.wasabisys.com/idbwmedia.com/images/luddite-eschewing-computers.jpg" alt="Luddite" /><figcaption>I'm not recommending rejection of ChatGPT. Instead, we should look to incorporate AI tools into writing scenarios that won't weaken our ability to write. This might be harder than it seems because whatever tasks you no longer perform, the skills to perform those tasks atrophy.</figcaption></figure>

Such generative AI writing will surely involve an echo chamber in which new writing is merely an imitation of everything online. And then, as the Internet gets populated by generative AI, ChatGPT's output will become a looping imitation of itself (assuming the language model is trained with its own output).

But that's not what's unsettling to me. What's unsettling is that writing itself becomes uninteresting. The act of writing with ChatGPT &mdash; feeding bullet points into a machine to organize and synthesize and articulate the ideas &mdash; reduces the activity to something far less engaging. Writing becomes a bore, an activity we abandon. 
...
The same fate of generative AI images and graphic designers will likely happen with ChatGPT and writers. For those who dislike writing and just want a tool to perform the task they don't want to do, it will work fine. Need a quick way to summarize the latest research on a topic? ChatGPT will do. 
