...
If you're not an ISTC member, you can read my article here: [Using Swagger (OpenAPI specification) for your API documentation](http://idratherbewriting.com/pubapis_swagger_intro/), since I also published the article on my site in HTML format and integrated into my API doc course. 
