...
The panelists were Leon Barnard ([@leonbarnard](http://twitter.com/leonbarnard)), Zach Corleissen ([@zachorsarah](http://twitter.com/))), Ted Hudek ([@tedhudek](http://twitter.com/tedhudek)), and John Bulava ([@jbulava](http://twitter.com/Bulava)).
...
A 2013 survey conducted by [Programmableweb](http://www.programmableweb.com/news/api-consumers-want-reliability-documentation-and-community/2013/01/07) including about 250 developers also found that "complete and accurate documentation" was the most important factor in an API.
...
(As exciting as it is to find these surveys, don't get too excited -- no one actually takes them seriously, as evidenced by the [steady decline](https://www.google.com/trends/explore#q=technical%20writer) or flatlining of employed tech writers.)
...
*  Ted at Microsoft moved toward another open model involving Markdown with a repository. Anyone can contribute docs, and contributing developers have a lively, quick process that seems to have a tremendous momentum and support.
...
If wikis didn't take off, why do we think this more current transformation process -- letting engineers write docs in code repositories using their editors and following Markdown syntax -- is going to be any more successful?

And if wikis didn't inspire everyone at the company to contribute, what will? Why didn't that model prove to be a successful catalyst for enabling openness, information sharing, and documentation contributions?
...
The best model I've found for getting engineers to contribute to documentation is to have engineers dump information on an internal wiki, and then I pull nuggets of information from there into my docs.
...
Even if engineers do want to write, they don't have time for it. Look back at the Stack Overflow survey -- their number one challenge is "unrealistic expectations." Companies expect engineers to work little miracles each day, turning out new APIs and software applications overnight rather than over a period of months. ()Also see my post, [Why "Programming Sucks" and the fallacy of documentation in the context of code chaos](http://idratherbewriting.com/2016/07/12/why-programming-sucks/) for more details about why programmers have little time to spend writing documentation.)

I do think the move toward *docs as code* is positive, if only because the open source model for software and processes is compelling and preferable to vendor lock-in, proprietary platforms, expensive tooling, black boxes, sales and marketing, and other characteristics of this model (that's another post, though).
...
At the end of the day, though, good documentation -- the kind engineers would find helpful, credible, and productivity-enabling -- is hard to write. It takes time and a lot of SME interactions to pull together code samples and good comments, sample apps, visual diagrams, tutorials, clearly articulated and logical concepts, easy-to-follow tasks, getting started tutorials, and more. Once published, maintaining docs requires regular maintenance, constant vigilance, and more. You need to keep aware of forum threads, support cases, newly added tickets, code changes, and more.
