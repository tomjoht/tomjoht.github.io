...
There's a [lively comment thread](https://www.linkedin.com/groups/162465/162465-6194890405864099844) in the Linkedin "DITA Awareness" Group about the place of Markdown. The thread begins: 
...
Sarah Maddox also recently shared tips on [How to get started with Markdown and where to try it out](https://ffeathers.wordpress.com/2016/09/24/how-to-get-started-with-markdown-and-where-to-try-it-out/). Sarah's opinion about Markdown is mixed. She writes:
...
There's even a new article on The Content Wrangler titled [Markdown: Markup That's Downright Simple](http://thecontentwrangler.com/2016/10/27/markdown-markup-thats-downright-simple/), where Erik Martin argues that the embrace of Markdown is a "backlash against digital precociousness". Erik writes, 

> ... as many electronic tools become more complex, others survive and thrive in a state of simplistic bliss—appealing to modern consumers with their retro charm and unfussy features.
