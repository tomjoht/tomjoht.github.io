...
- general
keywords: 
summary: "Apple's recent dongle fiasco raises an interesting tech comm question: Is there ever a time when you, as a technical writer, should apologize for something product-related in your documentation? I looked at Apple's end-user docs about their ports but didn't see any acknowledgement that they were inconveniencing their users in an extreme way. Instead, the tone was merely straightforward and factual about which adapters you would need, but there was no sense of apology or empathy with users about the plethora of dongles. When an issue is controversial or obviously of deep concern to users, documentation should address the issue head-on. You don't need to try to communicate about the issue in an emotional way (though that tone is usually welcome to users), you just need to *include* the information, mostly following Reddish's documentation as conversation model."
published: false
---
...
There's nothing in the documentation that hints at the inconvenience and cumbersomeness of these dongles/adapters. (Apple's docs use the term "adapter" instead of "dongle", but I think it's fun to call them "dongle docs.") 
...
As a best practice, follow Reddish's advice to imagine a conversation with your users. If they'll have specific questions, make these questions and issues explicit. 
...
In another section of my docs, one of the configuration steps for an app, was really confusing. I decided to stick this note before the long explanations of how to write the query syntax:
...
Still, I do think Apple's docs missed a point to show their humanity. You don't have to apologize in an emotional way in documentation. For example, you don't have to say, 
