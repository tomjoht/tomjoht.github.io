...
I've decided to start a [course on visual communication](http://idratherbewriting.com/2016/05/01/visualcommunication_course_overview/), similar to the course I wrote about [API documentation](http://idratherbewriting.com/learnapidoc/). With this approach, I write a couple of posts a week on the topic and try to arrange the posts into a course-like sequence. The idea is that rather than producing one-off blog posts, I leverage the power of the blogging medium to create a substantial body of information about a topic.
