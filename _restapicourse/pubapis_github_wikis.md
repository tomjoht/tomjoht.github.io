...
<a href="https://github.com/basecamp/bcx-api"><img src="{{ "/images_api/basecampapi.png" | prepend: site.baseurl }}" alt="Basecamp API" /></a>
...
2. After you're signed in, click the **+** button in the upper-right corner and select **New repository**.
	...
	<a href="https://github.com/new"><img src="{{ "/images_api/newrepositorygithub.png" | prepend: site.baseurl }}" alt="Creating a new Github repository" /></a>
...
3. Give the repository a name, description, select **Public**, select to **Initialize the repo with a README**, and then click **Create repository**.
	...
	<img src="{{ "/images_api/github_new_repo.png" | prepend: site.baseurl }}" alt="Creating a new Github repository" />
