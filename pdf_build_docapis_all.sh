...
bundle exec jekyll serve --config configs/_config_pdf_all.yml --limit_posts 1;
...
pdftk $LOCATION/docapis_all_chapters.pdf cat 1-8 output $LOCATION/course_overview.pdf
