...
pdftk $LOCATION/docapis_all_chapters.pdf cat 825-912 output $LOCATION/chapter16_ai_and_api_docs.pdf
pdftk $LOCATION/docapis_all_chapters.pdf cat 913-950 output $LOCATION/chapter17_glossary.pdf
pdftk $LOCATION/docapis_all_chapters.pdf cat 951-1014 output $LOCATION/chapter18_additional_resources.pdf
