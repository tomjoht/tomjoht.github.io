...
pdftk $LOCATION/docapis_all_chapters.pdf cat 334-352 output $LOCATION/chapter6_testing_api_docs.pdf
...
pdftk $LOCATION/docapis_all_chapters.pdf cat 732-813 output $LOCATION/chapter14_processes_and_methodology.pdf
