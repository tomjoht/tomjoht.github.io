...
{% include course_image.html dir="simplifying-complexity" size="medium" filename="jargon" ext_print="svg" ext_web="svg" alt="Without a mutual understanding of terms, the effectiveness of communication plummets" caption="Without a mutual understanding of terms, the effectiveness of communication plummets" %}
...
{% include course_image.html dir="simplifying-complexity" size="large" filename="background-knowledge-terms" ext_print="png" ext_web="png" alt="Helping users ramp up on background knowledge" caption="Helping users ramp up on background knowledge" %}
