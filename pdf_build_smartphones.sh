...
pdftk $LOCATION/journey_away_from_smartphones_all_chapters.pdf cat 4-61 output $LOCATION/chapter1-awakening.pdf
pdftk $LOCATION/journey_away_from_smartphones_all_chapters.pdf cat 62-113 output $LOCATION/chapter2-wayfinding.pdf
pdftk $LOCATION/journey_away_from_smartphones_all_chapters.pdf cat 114-201 output $LOCATION/chapter3-flow.pdf
pdftk $LOCATION/journey_away_from_smartphones_all_chapters.pdf cat 202-224 output $LOCATION/chapter4-pushandpull.pdf
