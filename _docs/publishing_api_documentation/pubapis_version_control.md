...
<figure><a href="http://github.com" class="noExtIcon"><img src="{{site.api_media}}/githubhomepage.png" alt="Github" /></a><figcaption>Github is a site that built tooling around Git.</figcaption></figure>
