...
<figure><a target="_blank" class="noExtIcon" href="https://pages.github.com/"><img class="docimage" src="{{site.api_media}}/githubpagesscreenshot.png" alt="GitHub Pages integration with GitHub repositories" /></a><figcaption>Every GitHub repository is potentially a Jekyll project that you can auto-build when you commit to it.</figcaption></figure>
...
<a href="https://docs.readthedocs.io/en/latest/getting_started.html" class="noExtIcon"><img src="{{site.api_media}}/readthedocsplatform.png" /></a>
