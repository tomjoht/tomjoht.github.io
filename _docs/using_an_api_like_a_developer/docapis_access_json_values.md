...
permalink: learnapidoc/docapis_access_json_values.html
categories:
- api-doc
keywords:
...
I'm assuming you're starting with the [same code](https://idratherbewriting.com/assets/files/weather-plain.html) from the [previous tutorial](docapis_json_console.html). That code looks like this:
...
2.  Refresh the page and you will see the wind speed printed to the page. Here's [an example](https://idratherbewriting.com/assets/files/weather-windspeed.html) with both wind speed and weather conditions.
...
Here's the code from the [sample page](https://idratherbewriting.com/assets/files/weather-windspeed.html):
