...
permalink: learnapidoc/docapis_more_about_authorization.html
weight: 7.3
sidebar: docapis
...
<figure><img class="docimage medium border" src="{{site.api_media}}/nonref_authentication.svg" alt="Authentication versus authorization" /><figcaption>Authentication and authorization</figcaption></figure>
...
<figure><img class="docimage large" src="{{site.api_media}}/nonref-docs-preso_apikey.svg" alt="APK keys use a string in a header property to authorize requests" /><figcaption>APK keys use a string in a header property to authorize requests</figcaption></figure>
...
<figure><img class="docimage medium border" src="{{site.api_media}}/restapi_hmac.svg" alt="HMAC workflow" /><figcaption>HMAC workflow</figcaption></figure>
...
<figure><img class="docimage " src="{{site.api_media}}/oauthwindow.png" alt="OAuth login window" /><figcaption>OAuth login window</figcaption></figure>
...
<figure><img class="docimage medium border" src="{{site.api_media}}/restapi_oauth.svg" alt="OAuth authentication" /><figcaption>OAuth authentication</figcaption></figure>
...
<figure><a target="_blank" class="noExtIcon" href="https://sendgrid.com/docs/User_Guide/Settings/api_keys.html"><img class="docimage" src="{{site.api_media}}/sendgrid_authorization.png" alt="SendGrid API keys" /></a><figcaption>SendGrid API keys</figcaption></figure>
...
<figure><a target="_blank" class="noExtIcon" href="https://developer.twitter.com/en/docs/basics/authentication/guides/authorizing-a-request"><img class="docimage" src="{{site.api_media}}/twitter_authentication.png" alt="Twitter authorization" /></a><figcaption>Twitter authorization</figcaption></figure>
...
<figure><a target="_blank" class="noExtIcon" href="https://www.dropbox.com/developers/reference/oauth-guide"><img class="docimage" src="{{site.api_media}}/dropbox_authentication.png" alt="Dropbox authorization" /></a><figcaption>Dropbox authorization</figcaption></figure>
