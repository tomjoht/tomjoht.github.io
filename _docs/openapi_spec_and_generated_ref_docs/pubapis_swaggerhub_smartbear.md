...
<p>You can see a demo export of the OpenWeatherAPI API here: <a href="https://idratherbewriting.com/assets/files/swaggerhub_htmloutput/index.html">HTML</a> or <a href="https://idratherbewriting.com/assets/files/swaggerhub_html2output/index.html">HTML2</a>. Both exports generate all the content into an index.html file.</p>
