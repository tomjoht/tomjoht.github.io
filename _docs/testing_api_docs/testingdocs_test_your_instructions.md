...
permalink: learnapidoc/testingdocs_test_your_instructions.html
weight: 6.3
sidebar: docapis
section: testingdocs
...
<a href="https://www.amazon.com/Id-Rather-Be-Writing-Podcast/dp/B06Y23TNC4/ref=sr_1_1?s=mobile-apps&ie=UTF8&qid=1491708630&sr=1-1&keywords=write+the+docs" class="noExtIcon"><img src="{{site.api_media}}/writethedocastfiretvapp.png" />

Here's what the app screens look like on your Fire TV:

<img src="{{site.api_media}}/wtdpodcastscreenshot1.png" alt="Write the Docs Podcast app" />

When you select a video, you see a video preview screen:

<img src="{{site.api_media}}/wtdpodcastscreenshot2.png" alt="Write the Docs Podcast app" />
