...
I also [gave a presentation on Docs-as-code tools and workflows](https://idratherbewriting.com/208/03/09/docs-as-code-tools-and-workflows-denver-presentation/) to the STC Rocky Mountain and WTD Denver group.
...
* [Discoveries and realizations while walking down the Docs-as-Code path](https://idratherbewriting.com/207/08/23/content-architecture-and-repo-sizes/)
* [Limits to the idea of treating docs as code](https://idratherbewriting.com/207/06/02/when-docs-are-not-like-code/)
* [Will the docs-as-code approach scale? Responding to comments on my Review of Modern Technical Writing](https://idratherbewriting.com/206/08/01/responding-to-feedback-on-modern-tech-writing-review/)
